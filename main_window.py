...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Tab 4: Turbulence Modeling
        self.tab_turbulence = TurbulenceTab()
        self.tabs.addTab(self.tab_turbulence, "4. Turbulence Modeling")

        # Call this after all tabs are instantiated so signal connections work
    ...
    def setup_conceptual_tab(self):
        ...
        self.sim_combo.currentTextChanged.connect(
            lambda text: self.tab_turbulence.update_regime(text) if hasattr(self, 'tab_turbulence') else None
        )
